...
export const Header = () => {
  ...
  return (
    <header
      id='header'
      className={twJoin('fixed top-0 z-30 flex flex-col justify-start w-full transition-all duration-100 h-headerHeight overflow-y-hidden', !isAtTop ? 'backdrop-blur-md backdrop-brightness-75' : '')}
    >
      <div
